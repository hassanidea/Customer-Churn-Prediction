...
voting_classifier_model = load_model('voting-clf.pkl')
...
def explain_prediction(probability, input_dict, surname):
  ...
  prompt = f"""You are an expert data scientist at a bank, where you specialize in interpreting and explaining predictions of machine learning models.
                ...
                Here is the custoemer's information:
                {input_dict}
  ...
  - If the customer has less than 40% risk of churning, generate a 3 sentence explanation of why they are not at of churning.
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Make sure to list out a set of incentives to stay based on their information, in bullet point format. Don't ever mention the probability of chruning, or the machine learning model to the customer.
  """
  raw_response = client.chat.completions.create(
